...
<head>
   ...
   <title>Checkout | Digital book hub</title>
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" name="flat" required placeholder="Flat.no/Door.no">
         </div>
         <div class="inputBox">
...
<h1 class = "title" align = "center" style = "color: blueviolet;font-size:xx-large;font-family: 'Times New Roman', Times, serif;">GENERATED QR CODE PAYMENT OPTIONS</h1>

   <div class="box-container">

   <div class="row">
        <div class="column">
          <img src="images/QR Code.jpg" alt="Gpay" style="width:100%">
        </div>
        <div class="column">
          <img src="images/Phonepe1.jpg" alt="PhonePe" style="width:100%">
        </div>
        <div class="column">
            <img src="images\BankQR.png" alt="BankQR" style="width:100%">
        </div>
    </div>
